...
Portfolio note: this folder contains the AKS platform blueprint's `boutique-app` sample workload. The source is based on the public Online Boutique microservices demo, so some upstream package names, generated code paths, and reference documentation intentionally retain their original attribution.
